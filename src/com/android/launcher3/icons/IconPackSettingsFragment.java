...
import com.android.launcher3.settings.RadioPreference;
import com.android.launcher3.settings.RadioSettingsFragment;
...
public final class IconPackSettingsFragment extends RadioSettingsFragment {
    ...
    private Set<IconPackInfo> getAvailableIconPacks(Context context) {
        ...
        availablePacks.add(new IconPackInfo(IconPackStore.DEFAULT_ICON_PACK, defaultLabel));
