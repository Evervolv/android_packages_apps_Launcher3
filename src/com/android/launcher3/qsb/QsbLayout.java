...
public class QsbLayout extends FrameLayout implements
    ...
    protected void onFinishInflate() {
        ...
        if (Utilities.isPackageEnabled(mContext, SEARCH_PACKAGE)) {
            enableLensIcon();
        }
    }
    ...
    private void enableLensIcon() {
        ...
        mLensIcon.setOnClickListener(view -> {
            ...
            bundle.putString("caller_package", SEARCH_PACKAGE);
            bundle.putLong("start_activity_time_nanos", SystemClock.elapsedRealtimeNanos());
            lensIntent.setComponent(new ComponentName(SEARCH_PACKAGE, LENS_ACTIVITY))
                    .addFlags(Intent.FLAG_ACTIVITY_NEW_TASK)
                    .setPackage(SEARCH_PACKAGE)
