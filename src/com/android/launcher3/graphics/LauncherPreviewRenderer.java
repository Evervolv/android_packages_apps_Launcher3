...
import com.android.launcher3.icons.LauncherIconFactory;
...
public class LauncherPreviewRenderer {
    ...
    public LauncherPreviewRenderer(Context context, InvariantDeviceProfile idp, boolean migrated) {
        ...
        LauncherIconFactory iconFactory =
                new LauncherIconFactory(context, mIdp.fillResIconDpi, mIdp.iconBitmapSize) { };
